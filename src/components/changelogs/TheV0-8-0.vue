<template>
  ...
  <p>
    Added <code>icon</code> slot on multiple components:
  </p>
  <p>
    <ul>
      <li>
        <mk-link to="/component/alert">
  ...
  <p>
    Added <code>placeholder</code> prop on multiple components:
  </p>
  <p>
    <ul>
      <li>
  ...
  <p>
    Cleaned unused <mk-link to="/component/wysiwyg-preview">
